...
layout: single
title: "Xinwen Zhang"
permalink: /people/xinwen-zhang/
author_profile: true
---

<div class="person-profile">
  <img class="person-profile__photo" src="{{ '/images/people/xinwen-zhang.jpg' | relative_url }}" alt="Xinwen Zhang">
  <div class="person-profile__summary">
    <p class="person-profile__role">PhD Student</p>
    <p><strong>Email:</strong> <a href="mailto:zhangxw@stu.pku.edu.cn">zhangxw@stu.pku.edu.cn</a></p>
